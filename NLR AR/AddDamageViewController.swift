...
class AddDamageViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // Navigation
        self.title = "Save the report"
        let saveButton = UIBarButtonItem(title: "Save", style: .done, target: self, action: #selector(saveDamage))
        self.navigationItem.rightBarButtonItem = saveButton
        let cancelButton = UIBarButtonItem(title: "Cancel", style: .plain, target: self, action: #selector(cancelDamage))
